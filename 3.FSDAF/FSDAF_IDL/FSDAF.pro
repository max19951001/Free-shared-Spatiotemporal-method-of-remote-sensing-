...
;      Note: this version uses ISODATA to classify fine image automatically, so users do not need to input pre-classified fine image. 
;      This version is appropriate for areas with land cover types eaily differentiated by unsupervised classifiers. 
;        
